    ...
    <Card className='shadow'>
        ...
        <CardContent>
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                ...
                <SliderData
                name='muJ' 
                hint='his is the expected size of the jumps. A positive value will cause the jumps to increase the asset price on average, while a negative value will cause the jumps to decrease the asset price on average.' 
                max={1}
                min={-1}
                step={0.05}
                value={params.muJ}
...
{/*                 <SliderData
                name='T' 
                hint='Explanation of T' 
                max={10}
                min={1}
                step={1}
                value={params.T}
                setValue={(newValue) => setParams((prevParams: any) => ({ ...prevParams, T: newValue }))}
                /> */}
            </div>
